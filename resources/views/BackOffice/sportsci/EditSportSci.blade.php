                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form action="{{route('sportsci.update', $sportsci->id)}}" method="post">
                                    @csrf
                                    {{ method_field('PATCH') }}
                                    <label for="type">Type :</label>                                    
                                    <select class="select2-multi form-control" name="type">
                                      <option value="{{$sportsci->type}}">{{$sportsci->type}}</option>
                                    ...
                                    <input type="text" name="title" value="{{$sportsci->title}}" required="require" class="form-control">
                                    <br><br>
                                    
                                    <label for="image">Image :</label>
                                    <input type="file" class="dropify" name="image" data-default-file="{{asset("img/$sportsci->image")}}" />
                                    <br><br>

                                    <label for="detail">Detail :</label>                                
                                    <textarea name="detail" id="editor">{!!$sportsci->detail!!}</textarea>
                                    <br><br>                                    
