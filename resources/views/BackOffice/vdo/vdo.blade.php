        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <a class="btn btn-primary" href="{{ route('vdo.create') }}"><i class="fas fa-plus"></i> Add</a>
                    </div>
                </div>
                <!-- /. ROW  -->
                <div class="row">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody class="text-center">
                                             ...
                                             <tr class="odd gradeX">
                                                ...
                                                <td>{{$v->type_name}}</td>
                                                <td>{{$v->title}}</td>
                                                <td><iframe src="https://www.youtube.com/embed/{{ $v->vdo }}"></iframe></td>
                                                <td>
                                                    <div class="form-group d-flex justify-content-around">
                                                        <a href="{{route('vdo.edit', $v->id)}}"> 
                                                            <button type="submit" class="btn btn-warning btn-circle btn-sm"><i class="fas fa-pencil-alt"></i></button>
                                                        </a>

                                                        <form action="{{ route('vdo.destroy', $v->id) }}" method="POST">
                                                            {!! method_field('DELETE') !!}
                                                            @csrf
